...
const Indicator = ({
  ...
  const wrapperStyles: Animated.AnimatedProps<ViewStyle> = {
    ...
    transform: [
      vertical
        ? { translateY: translateWrapper }
        : { translateX: translateWrapper },
    ],
  };
  ...
  const leftStyles: Animated.AnimatedProps<ViewStyle> = {
    ...
    [vertical ? 'borderTopRightRadius' : 'borderBottomLeftRadius']:
      borderRadius,
    transform: [
      vertical ? { translateY: translateLeft } : { translateX: translateLeft },
    ],
  };
  ...
  const rightStyles: Animated.AnimatedProps<ViewStyle> = {
    ...
    [vertical ? 'borderBottomLeftRadius' : 'borderTopRightRadius']:
      borderRadius,
    transform: [
      vertical
        ? { translateY: translateRight }
    ...
    <View style={rootStyles}>
      ...
      {overlay && (
        <Animated.View style={overlayStyles}>
          <View style={styles.mask}>
            <Animated.View
              style={[leftStyles, { backgroundColor: activeColor }]}
            />
          </View>
          <View style={styles.mask}>
            <Animated.View
              style={[rightStyles, { backgroundColor: activeColor }]}
            />
          </View>
        </Animated.View>
      )}
