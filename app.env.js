 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.synnexfpt.appbacsi.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'com.synnexfpt.appbacsi'; // ios bundle id
const PACKAGE = BUNDLE_ID; // android package name
const NAME = 'nhapthuoc.com BacSi'; // app name
const EXPO_ACCOUNT_OWNER = 'synnexfpt'; // expo account owner
const EAS_PROJECT_ID = 'f646d97d-a73d-4421-802c-b4063d542cd0'; // eas project id
const SCHEME = 'appbacsi'; // app scheme
