...
import IndicatorBeads from './indicator-beads';
import IndicatorMorse from './indicator-morse';
import IndicatorTrain from './indicator-train';
  ...
  if (variant === Variants.MORSE) {
    rootStyle.push({
      [vertical ? 'height' : 'width']:
        morseDashSize + pixelSize * (count - 1) + gap * count,
    });
  }
